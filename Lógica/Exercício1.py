#Mensgaem de boas vindas com nome completo
print('Bem-vindo a loja da Barbara Bianca!')
...
#Implementando a taxa de juros de acordo com os dados fornecidos
...
print(f'Valor dos juros aplicados e de: {juros * 100:.0f}%')
